...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/kategorys": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Kategory Input",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.KategoryInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReviewsInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/transaction-product/{transaction_id}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Transaction Product Input",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransactionProductInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.TransactionProductInput": {
            "type": "object",
            "required": [
                "price_at_purchase",
                "product_id",
